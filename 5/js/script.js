...
/* harmony import */ var _modules_animation_of_words_by_letter__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/animation-of-words-by-letter */ "./source/js/modules/animation-of-words-by-letter.js");
// modules
...
const animationTopScreenTextLine = new _modules_animation_of_words_by_letter__WEBPACK_IMPORTED_MODULE_10__["default"](`.intro__title`, 300, `active-word`, `transform`);
setTimeout(()=>{
  animationTopScreenTextLine.runAnimation();
}, 600);

const animationDate = new _modules_animation_of_words_by_letter__WEBPACK_IMPORTED_MODULE_10__["default"](`.intro__date`, 300, `active-word`, `transform`, 500);
animationDate.runAnimation();

const animationTitleStory = new _modules_animation_of_words_by_letter__WEBPACK_IMPORTED_MODULE_10__["default"](`.slider__item-title`, 300, `active-word`, `transform`);
setTimeout(()=>{
  animationTitleStory.runAnimation();
}, 600);

let animationTitlePrizes = new _modules_animation_of_words_by_letter__WEBPACK_IMPORTED_MODULE_10__["default"](`.prizes__title`, 300, `active-word`, `transform`);
setTimeout(()=>{
