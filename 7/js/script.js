...
/***/ "./source/js/modules/animation-of-words-by-letter.js":
/*!***********************************************************!*\
  !*** ./source/js/modules/animation-of-words-by-letter.js ***!
  \***********************************************************/
/*! exports provided: default */
    ...
    if (this._element) {
      ...
      const content = text.reduce((fragmentParent, word) => {
        const wordElement = Array.from(word).reduce((fragment, latter) => {
          ...
          this._timeOffset = Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["randomNumber"])(25, 200, 25);
          return fragment;
...
/* harmony import */ var _init_animation_title__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./init-animation-title */ "./source/js/modules/init-animation-title.js");
/* harmony import */ var _remove_active_slide_class__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./remove-active-slide-class */ "./source/js/modules/remove-active-slide-class.js");
...
class FullPageScroll {
  ...
  changePageDisplay() {
    ...
    Object(_init_animation_title__WEBPACK_IMPORTED_MODULE_1__["resetAnimationTitle"])();
    Object(_init_animation_title__WEBPACK_IMPORTED_MODULE_1__["initAnimationTitle"])();
  }
  ...
  changeVisibilityDisplay() {
    ...
    setTimeout(() => {
      ...
      Object(_remove_active_slide_class__WEBPACK_IMPORTED_MODULE_2__["default"])(this.body, this.MAX_QUANTITY_OF_SLIDES);
...
/***/ "./source/js/modules/init-animation-title.js":
/*!***************************************************!*\
  !*** ./source/js/modules/init-animation-title.js ***!
  \***************************************************/
/*! exports provided: initAnimationTitle, resetAnimationTitle */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initAnimationTitle", function() { return initAnimationTitle; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "resetAnimationTitle", function() { return resetAnimationTitle; });
/* harmony import */ var _animation_of_words_by_letter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./animation-of-words-by-letter */ "./source/js/modules/animation-of-words-by-letter.js");


const animationTopScreenTextLine = new _animation_of_words_by_letter__WEBPACK_IMPORTED_MODULE_0__["default"](`.intro__title`, 300, `active-word`, `transform`, 400);
const animationDate = new _animation_of_words_by_letter__WEBPACK_IMPORTED_MODULE_0__["default"](`.intro__date`, 300, `active-word`, `transform`, 1200);
const animationTitleStory = new _animation_of_words_by_letter__WEBPACK_IMPORTED_MODULE_0__["default"](`.slider__item-title`, 300, `active-word`, `transform`, 400);
const animationTitlePrizes = new _animation_of_words_by_letter__WEBPACK_IMPORTED_MODULE_0__["default"](`.prizes__title`, 300, `active-word`, `transform`, 400);
const animationTitleRules = new _animation_of_words_by_letter__WEBPACK_IMPORTED_MODULE_0__["default"](`.rules__title`, 300, `active-word`, `transform`, 400);
const animationTitleGame = new _animation_of_words_by_letter__WEBPACK_IMPORTED_MODULE_0__["default"](`.game__title`, 300, `active-word`, `transform`, 400);

const initAnimationTitle = () => {
...
/***/ "./source/js/modules/remove-active-slide-class.js":
/*!********************************************************!*\
  !*** ./source/js/modules/remove-active-slide-class.js ***!
  \********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ((element, lenght) => {
...
/* harmony import */ var _remove_active_slide_class__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./remove-active-slide-class */ "./source/js/modules/remove-active-slide-class.js");
  ...
  const setSlider = function () {
    if (((window.innerWidth / window.innerHeight) < 1) || window.innerWidth < 769) {
      storySlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](`.js-slider`, {
        ...
        on: {
          slideChange: () => {
            Object(_remove_active_slide_class__WEBPACK_IMPORTED_MODULE_1__["default"])(body, 7);
      ...
      storySlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](`.js-slider`, {
        ...
        on: {
          slideChange: () => {
            Object(_remove_active_slide_class__WEBPACK_IMPORTED_MODULE_1__["default"])(body, 6);
            body.classList.add(`js-active-slide-${storySlider.activeIndex}`);
...
/* harmony import */ var _modules_header__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/header */ "./source/js/modules/header.js");
/* harmony import */ var _modules_init_animation_title__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/init-animation-title */ "./source/js/modules/init-animation-title.js");
// modules
...
Object(_modules_header__WEBPACK_IMPORTED_MODULE_9__["default"])();
Object(_modules_init_animation_title__WEBPACK_IMPORTED_MODULE_10__["initAnimationTitle"])();
